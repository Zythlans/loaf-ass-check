...
try:
    ...
    exit(1)
os.system("cls")
ctypes.windll.kernel32.SetConsoleTitleW("UGC sniper happy now loaf??")
...
print(textToColour(f"[COLOR_LIGHT_BLUE]UGC-Sniper made by: urmom (Loaf) and  (maxhithere)\n"
                   f"[COLOR_LIGHT_BLUE]contact me if ur dum and dunno how dis works"))
time.sleep(0.1)
